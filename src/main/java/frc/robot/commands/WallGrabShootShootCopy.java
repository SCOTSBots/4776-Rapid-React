...
public class WallGrabShootShootCopy extends SequentialCommandGroup {
  public WallGrabShootShootCopy(DriveSubsystem drive, Shooter shooter, IntakePackage intakePackage, Intake intake,
    ...
    Trajectory driveToBallTrajectory = TrajectoryGenerator.generateTrajectory(
        ...
        // Drive Forward
        List.of(new Translation2d(DISTANCE/3, -0.75)),
        // End 3 meters straight ahead of where we started, facing forward
        new Pose2d(DISTANCE, -0.75, new Rotation2d(Math.toRadians(0))),
        config);


    Trajectory driveToShootTrajectory = TrajectoryGenerator.generateTrajectory(
        // Start at the origin facing the +X direction
        new Pose2d(DISTANCE, -0.75, new Rotation2d(0)),
        // Drive Forward
