...
public class GrabShootShootAlt extends SequentialCommandGroup {
  public GrabShootShootAlt(DriveSubsystem drive, Shooter shooter, IntakePackage intakePackage, Intake intake,
    ...
    Trajectory driveToShootTrajectory = TrajectoryGenerator.generateTrajectory(
        ...
        // Drive Forward
        List.of(new Translation2d(DISTANCE/2, 0.5)),
        // End 3 meters straight ahead of where we started, facing forward
        new Pose2d(0, 1, new Rotation2d(Math.toRadians(-150.0))),
        config);
